...
import in.albertnegoro.restapi.io.ExpenseRequest;
...
public class ExpenseController {
    ...
    public ExpenseResponse saveExpenseDetails(@Valid @RequestBody ExpenseRequest expenseRequest) {
        log.info("API POST /expense called {}", expenseRequest);
    ...
    public ExpenseResponse updateExpenseDetails(@RequestBody ExpenseRequest updateRequest, @PathVariable String expenseId) {
        ...
        log.info("Printing the updated ExpenseDTO details {}", updatedExpenseDTO);
